...
(custom-theme-set-faces
 'SixColors
 '(default ((t (:family "Source Code Pro for Powerline" :foundry "outline" :width normal :height 98 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "ivory" :background "gray8" :stipple nil :inherit nil))))
 '(cursor ((t (:foreground "#000000" :background "#009CDF"))))
 '(fixed-pitch ((t (:family "Monospace"))))
 '(variable-pitch ((((type w32)) (:foundry "outline" :family "Arial")) (t (:family "Sans Serif"))))
 '(escape-glyph ((t (:foreground "#973999"))))
 '(homoglyph ((t (:foreground "#973999"))))
 '(minibuffer-prompt ((t (:foreground "#f78200"))))
 '(highlight ((t (:background "#5ebd3e" :weight bold))))
 '(region ((t (:extend t :background "#009CDF" :weight bold))))
 ...
 '(font-lock-string-face ((t (:foreground "#973999"))))
 ...
 '(isearch ((t (:background "#5EBD3E" :weight bold))))
 '(isearch-fail ((t (:background "#e23838"))))
 '(lazy-highlight ((t (:background "#f78200"))))
 '(match ((t (:background "#5EBD3E" :weight bold))))
 '(next-error ((t (:inherit (region)))))
 '(query-replace ((t (:inherit (isearch)))))
 '(orderless-match-face-0 ((((class color) (min-colors 88) (background dark)) (:foreground "#ffb900" :weight bold))))
 '(show-paren-match ((t (:foreground "#000000" :background "#5EBD3E" :weight bold))))
 '(company-tooltip-common ((t (:foreground "#000000" :background "#5EBD3E" :weight bold))))
 '(company-tooltip-common-selection ((t (:foreground "#000000" :background "#FFB900" :weight bold))))
 '(company-tooltip-quick-access ((t (:foreground "#000000" :background "#5EBD3E" :weight bold))))
 '(company-tooltip-quick-access-selection ((t (:foreground "#000000" :background "#FFB900" :weight bold))))
